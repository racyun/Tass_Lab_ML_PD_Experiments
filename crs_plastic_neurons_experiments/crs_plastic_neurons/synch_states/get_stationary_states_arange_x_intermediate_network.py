...
print('initial mean weight in units of max weight')
initialMeanWeight = 0.5
...
# define connection probablities for inhomogeneous and homogeneous network
# PconInhomogeneous = 0.035
PconInhomogeneous = 0.14
PconHomogeneous = system_parameters['P_STN_STN'] 

# parameter that scales between homogeneous and inhomogeneous network
# (lambPar = H)
lambPar = float(sys.argv[3])

## set initial mean weight
system_parameters['cExcInit'] = initialMeanWeight*system_parameters['cMaxExc'] 
## set simulation time
system_parameters['Tend'] = 3020.0 # sec
# system_parameters['Pcon'] = Pcon # mm
...
# synConnections , cMatrix , neuronLoc , sim_objects = functions_genNetwork.sequence_paper_generate_circular_network(   system_parameters , rnd_state_for_network_generation, Pcon )
synConnections , cMatrix , neuronLoc , sim_objects = functions_genNetwork.sequence_paper_generate_transition_network( system_parameters , rnd_state_for_network_generation, PconInhomogeneous, PconHomogeneous, lambPar )
