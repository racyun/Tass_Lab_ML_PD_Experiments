...
initialMeanWeight = float(sys.argv[3])
print('connection probability for circular network Pcon')
...
## set simulation time
system_parameters['Tend'] = 13200.0 # sec
...
synConnections , cMatrix , neuronLoc , sim_objects = functions_genNetwork.sequence_paper_generate_circular_network( system_parameters , rnd_state_for_network_generation )
