...
# this is the directory from which simulation is started
...
# total simulation time in seconds after start of relaxation
SimulationTime=int(sys.argv[2])

# create a complete backup only at the following times
TBackupSteps = np.arange(10220,50000,1000) # sec
...
outputFolder= outputParentDirectory+'/relaxation_Tsim_'+str(SimulationTime)
